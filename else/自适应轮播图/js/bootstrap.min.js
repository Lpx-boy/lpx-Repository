...
!function (a) {
  ...
  c.prototype = {
    ...
    keydown: function (c) {
      ...
      h = e(d),
      i = h.hasClass('open');
      if (!i || i && c.keyCode == 27) return c.which == 27 && h.find(b).focus(),
      d.click();
  ...
  b.prototype = {
    ...
    refresh: function () {
      ...
      c = this.$body.find(this.selector).map(function () {
        ...
        e = /^#\w/.test(d) && a(d);
        return e && e.length && [[e.position().top + (!a.isWindow(b.$scrollElement.get(0)) && b.$scrollElement.scrollTop()),
        d]] || null
      }).sort(function (a, b) {
        return a[0] - b[0]
      }).each(function () {
...
!function (a) {
  ...
  a.fn.collapse = function (c) {
    return this.each(function () {
      ...
      e = d.data('collapse'),
      f = a.extend({
      }, a.fn.collapse.defaults, d.data(), typeof c == 'object' && c);
...
!function (a) {
  ...
  a(document).on('click.carousel.data-api', '[data-slide], [data-slide-to]', function (b) {
    ...
    g;
    e.carousel(f),
    (g = c.attr('data-slide-to')) && e.data('carousel').pause().to(g).cycle(),
    b.preventDefault()
  })
}(window.jQuery),
!function (a) {
